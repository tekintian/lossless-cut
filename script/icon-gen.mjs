...
await svg2png(
  "src/icon.svg",
  "./build-resources/appx/Square150x150Logo.png",
  300,
  300
);
await svg2png(
  "src/icon.svg",
  "./build-resources/appx/Square44x44Logo.png",
  44,
  44
);
await svg2png(
  "src/icon.svg",
  "./build-resources/appx/Wide310x150Logo.png",
  620,
  300
);

// MacOS:
// https://github.com/tekintian/lossless-cut/issues/1820
await icongen("./src/icon-mac.svg", "./icon-build", {
  icns: { sizes: [512, 1024] },
});

// Windows ICO:
// https://github.com/tekintian/lossless-cut/issues/778
// https://stackoverflow.com/questions/3236115/which-icon-sizes-should-my-windows-applications-icon-include
await icongen("./src/icon.svg", "./icon-build", {
