...
// menu-safe i18n.t:
// https://github.com/tekintian/lossless-cut/issues/1456
  ...
  const menu = [
...

    {
      ...
      submenu: [
        ...
        // https://github.com/tekintian/lossless-cut/issues/1183
...

    {
      ...
      submenu: [
        ...
        },
        {
          ...
          click() {
            mainWindow.webContents.send("toggleLastCommands");
          },
        },
        { type: "separator" },
      ...
      submenu: [
        {
          ...
          click() {
            electron.shell.openExternal(
              "https://api.tekin.cn/losslesscut/support"
            );
          },
        },
        {
          label: esc(t("FAQ")),
          click() {
            electron.shell.openExternal("https://api.tekin.cn/losslesscut/faq");
          },
        },
        {
          ...
          click() {
            electron.shell.openExternal(
              "https://api.tekin.cn/losslesscut/troubleshooting"
            );
          },
        },
        {
        ...
        },
        {
          ...
          click() {
            electron.shell.openExternal(
              "https://github.com/tekintian/lossless-cut/issues"
            );
          },
        },
        { type: "separator" },
        {
          ...
          click() {
            electron.shell.openExternal(licensesPage);
          },
        },
        { type: "separator" },
        {
          label: esc(t("Yunnan Software Developer")),
          click() {
            electron.shell.openExternal("https://dev.yunnan.ws");
          },
        },
        ...(process.platform !== "darwin"
          ? [{ role: "about", label: esc(t("About LosslessCut")) }]
          : []),
      ],
    },
  ];
      ...
      submenu: [
        {
          ...
          click() {
            electron.shell.openExternal(getReleaseUrl(newVersion));
          },
        },
      ],
    });
